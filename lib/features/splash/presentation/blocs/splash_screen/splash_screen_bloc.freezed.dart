...
extension SplashEventPatterns on SplashEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(LoadSplash value)? load,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case LoadSplash() when load != null:
        return load(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(LoadSplash value) load,
  }) {
    final _that = this;
    switch (_that) {
      case LoadSplash():
...
class LoadSplash implements SplashEvent {
  const LoadSplash();

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is LoadSplash);
  }
...
class _Success implements SplashState {
  ...
  @override
  String toString() {
    return 'SplashState.success(message: $message)';
  }
}
