...
extension SearchEventPatterns on SearchEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(LoadSearch value)? load,
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(LoadSearch value) load,
  }) {
    final _that = this;
    switch (_that) {
      case LoadSearch():
...
class LoadSearch implements SearchEvent {
  const LoadSearch();

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is LoadSearch);
  }
...
class _Success implements SearchState {
  ...
  @override
  String toString() {
    return 'SearchState.success(message: $message)';
  }
}
